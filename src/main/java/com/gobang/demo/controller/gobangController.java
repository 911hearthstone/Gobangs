...
public class gobangController {
    ...
    @ResponseBody
    public void RemoveCursor() throws IOException {
      ChangedGobang();
    }
    ...
    @ResponseBody
    public String count0(String sendflag){
        int flag=Integer.parseInt(sendflag);
        if(flag==0) {
    ...
    @ResponseBody
    public String count1(String sendflag){
        int flag=Integer.parseInt(sendflag);
        if (flag==0){
    ...
    @ResponseBody
    public String colour(String sendflag){
        int flag=Integer.parseInt(sendflag);
        if (flag==0) {
    ...
    @ResponseBody
    public String count3(String sendflag){
        int flag=Integer.parseInt(sendflag);
        if (flag==0) {
